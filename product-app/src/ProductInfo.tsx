...
export default function ProductInfo() {
  return (
    <>
      ...
      <div className="flex px-10 mt-7 flex-col gap-5">
        <div className=" bg-gray-100 w-full h-14 max-h-full flex justify-between items-center rounded-xl ">
        ...
        <div className="rounded-xl flex gap-3 justify-center items-center py-5 bg-orange-500">
